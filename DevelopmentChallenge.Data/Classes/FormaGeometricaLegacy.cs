...
{
    public class FormaGeometricaLegacy
    {
        #region Formas
        ...
        public FormaGeometricaLegacy(int tipo, decimal ancho)
        {
            Tipo = tipo;
            _lado = ancho;
        }

        public static string Imprimir(List<FormaGeometricaLegacy> formas, int idioma)
        {
